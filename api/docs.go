...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/devices/{device_id}/commands/execute": {
            "post": {
        ...
        "/api/v1/devices/{device_id}/datamodel": {
            "get": {
        ...
        "/api/v1/devices/{device_id}/objects": {
            "get": {
        ...
        "/api/v1/devices/{device_id}/objects/{object_path}": {
            "get": {
        ...
        "/api/v1/devices/{device_id}/parameters/search": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Parameter path to search",
                        "name": "path",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/devices/{device_id}/parameters/set": {
            "post": {
        ...
        "/api/v1/devices/{device_id}/schema": {
            "get": {
        ...
        "/api/v1/devices/{device_id}/subscriptions": {
            "get": {
        ...
        "/api/v1/devices/{device_id}/subscriptions/{subscription_id}": {
            "delete": {
